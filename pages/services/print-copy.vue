<template>
    <main class="flex flex-col gap-12 w-full items-center mb-12 mt-24 sm:mt-36">
        <section class="w-full flex flex-col px-8 justify-between gap-12 my-3 sm:my-7 max-w-6xl lg:px-12">
            ...
            <div class="flex flex-col gap-8 md:grid md:grid-cols-2 md:gap-16">
                <div class="flex flex-col gap-10 mb-8 relative lg:mb-0">
                    <div class="flex flex-col gap-4">
                        <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display text-sand-800 dark:text-sand-300">Overview:</h2>
                        <p class="max-w-prose">
                ...
                <div class="flex flex-col gap-4 text-center relative">
                    ...
                    <span class="italic">picture caption</span>
                </div>
            </div>
        </section>
        <section class="px-8 flex flex-col justify-center mb-12 gap-6 max-w-6xl">
            <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display text-sand-800 dark:text-sand-300">Features:</h2>
            <div class="grid grid-cols-2 md:flex md:flex-wrap md:gap-4 md:justify-start">
                <ImgBlock class="md:max-w-56" img="/rect.png"><span class="font-semibold text-xl">Lorem</span></ImgBlock>
                <ImgBlock class="md:max-w-56" img="/rect.png"><span class="font-semibold text-xl">Lorem</span></ImgBlock>
                <ImgBlock class="md:max-w-56" img="/rect.png"><span class="font-semibold text-xl">Lorem</span></ImgBlock>
                <ImgBlock class="md:max-w-56" img="/rect.png"><span class="font-semibold text-xl">Lorem</span></ImgBlock>
                <ImgBlock class="md:max-w-56" img="/rect.png"><span class="font-semibold text-xl">Lorem</span></ImgBlock>
        ...
        <section class="w-full px-8 flex flex-col justify-center mb-12 gap-6 max-w-6xl">
            <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display text-sand-800 dark:text-sand-300">Frequently Asked Questions:</h2>
