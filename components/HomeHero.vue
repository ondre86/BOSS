<template>
    <section
        class="w-full flex flex-col px-8 justify-between gap-8 my-3 sm:my-7 sm:mb-12 max-w-6xl lg:flex-row lg:gap-24 lg:px-12"
    >
        <div class="flex flex-col gap-4 mb-8 relative lg:mb-0 hero-text">
            <div class="flex flex-col gap-2">
                <h1
                    class="text-4xl text-sand-800 dark:text-sand-300 lg:text-6xl -ml-1"
                >
                    New Orleans Business and Shipping Center
                </h1>
                <span class="font-display text-sand-800 dark:text-sand-300"
                    >Business Operations Services and Solutions</span
                >
            </div>
            ...
            <LogoIcon
                :svg-size="'1750px'"
                class="absolute -z-10 opacity-5 -bottom-272 -left-260 hidden lg:block"
            >
            </LogoIcon>
        </div>
