<template>
    <footer class="flex flex-col border-t py-4 px-8 gap-8 md:justify-between">
        ...
        <nav>
            <ul class="flex w-fit flex-col gap-4">
                ...
                <li class="flex flex-col text-xl font-semibold text-sand-300 w-fit">
                    <ul class="flex flex-wrap gap-4">
                        <li class="underline underline-offset-2 transition-all duration-300 hover:underline-offset-8 text-sand-800 dark:text-sand-300 hover:text-sand-500">
                            <NuxtLink
                                to="/services/notary"
                            >
                                Notary
        ...
        <span class="text-sm text-sand-800 dark:text-sand-300">© 2025 BOSS</span>
    </footer>
</template>
