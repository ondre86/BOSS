<template>
    <div class="w-fit h-fit" ref="logoWrap">
        <svg viewBox="0 0 587 587" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path data-animate="path-4" d="M293.507 485.988L100.232 292.733L68.0317 324.92L293.507 550.415L519.007 324.92L486.794 292.707L293.507 485.988Z" fill="url(#paint5_linear_2_24)" stroke="url(#paint6_linear_2_24)" stroke-width="26.3415" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            <defs>
                ...
                <linearGradient id="paint5_linear_2_24" x1="68.0317" y1="292.707" x2="519.007" y2="292.707" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#945F50"/>
                    <stop offset="0.5" stop-color="#FCC5B3"/>
                    <stop offset="1" stop-color="#945F50"/>
                </linearGradient>
                <linearGradient id="paint6_linear_2_24" x1="68.0317" y1="292.707" x2="519.007" y2="292.707" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#945F50"/>
                    <stop offset="0.5" stop-color="#FCC5B3"/>
                    <stop offset="1" stop-color="#945F50"/>
                </linearGradient>
